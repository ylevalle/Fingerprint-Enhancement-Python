...
def ridge_orient(im: NumpyArray, gradientsigma: int, blocksigma: int, 
                 orientsmoothsigma: int) -> NumpyArray:
    ...
    orientim: NumpyArray = np.pi / 2 + np.arctan2(sin2theta, cos2theta) / 2
